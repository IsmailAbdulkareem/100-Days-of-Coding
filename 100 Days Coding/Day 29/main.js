...
function findCodePosition(str) {
    return str.indexOf("with"); // Looks for "code" and tells where it found it
}
...
console.log(hasJavaScript("I love coding in Script!")); // Outputs true or false based on the check
