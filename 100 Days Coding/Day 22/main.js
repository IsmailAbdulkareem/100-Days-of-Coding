...
//nction combineStringAndNumber(text: string, number: number): string {
//  // Joins the text and number into a single text
//  return text + number;
//
//
// Trying it out with "Age: " and 30
//nsole.log(combineStringAndNumber("Age :" ,19)); // Shows "Age: 30"
...
//nsole.log(remainder(5, 2)); // Shows 1
// This tells us the leftover, which is 1 here.
//nction remain(num1:number, num2:number) : number {
//  return num1 % num2;
//
//
//nsole.log(remain(8,3))
